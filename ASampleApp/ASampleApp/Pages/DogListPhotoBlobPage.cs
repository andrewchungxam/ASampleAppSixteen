...
//{
//    public class DogListPhotoBlobPage
//    {
//        public DogListPhotoBlobPage()
//        {
//        }
//    }
//}
...
namespace ASampleApp
{
	public class DogListPhotoBlobPage : BaseContentPage<DogListPhotoBlobViewModel>
	{
		...
		public DogListPhotoBlobPage()
		{
			...
			var myTemplate = new DataTemplate(typeof(DogPhotoBlobViewCell));
			_dogListView.ItemTemplate = myTemplate;
	...
	public class DogPhotoBlobViewCell : ViewCell
	{
		MenuItem _deleteAction;

		public DogPhotoBlobViewCell()
		{
		...
		private void HandleDeleteActionClicked(object sender, EventArgs e)
		{
            ...
            App.DogRepBlob.DeleteDogBlob(selectedModel);
			...
			var dogListPhotoPage = navigationPage.CurrentPage as DogListPhotoBlobPage;
			var dogListPhotoViewModel = dogListPhotoPage.BindingContext as DogListPhotoBlobViewModel;
