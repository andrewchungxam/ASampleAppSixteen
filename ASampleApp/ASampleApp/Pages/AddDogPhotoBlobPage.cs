...
namespace ASampleApp.Pages
{
	public class AddDogPhotoBlobPage : BaseContentPage<AddDogPhotoBlobViewModel>
	{
		Label _firstLabel;
		Entry _firstEntry;
		Entry _secondEntry;
		...
		void MyViewModel_TakePhotoFailed(object sender, AddDogPhotoBlobViewModel.AlertEventArgs e)
		{
			Device.BeginInvokeOnMainThread(async () =>
										   await DisplayAlert(e.Title, e.Message, "OK"));
		}

		private void MyViewModel_TakePhotoSucceeded(object sender, AddDogPhotoBlobViewModel.PhotoSavedSuccessAlertEventArgs e)
		{
			Device.BeginInvokeOnMainThread(async () =>
										   await DisplayAlert(e.Title, e.Message, "OK"));
